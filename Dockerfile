...
ENTRYPOINT ["java","-javaagent:applicationinsights-agent.jar","--enable-preview","--add-opens=java.base/javax.crypto.spec=ALL-UNNAMED","org.springframework.boot.loader.JarLauncher"]
