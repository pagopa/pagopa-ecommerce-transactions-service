...
public final class TransactionInitEvent extends TransactionEvent<TransactionInitData> {
    public TransactionInitEvent(String transactionId, String rptId, String paymentToken, String creationDate, TransactionInitData data) {
        super(transactionId, rptId, paymentToken, TransactionEventCode.TRANSACTION_INITIALIZED_EVENT, creationDate, data);
    }
