 ...
 * </p>
 * <p>
 * Each aggregate root has an identifier (an <code>@AggregateId</code>) which
 * can be used to refer to this aggregate root by other aggregate roots.
 * Entities inside aggregate roots should never be referenced by external
 * aggregate roots.
 * </p>
 */
@Documented
