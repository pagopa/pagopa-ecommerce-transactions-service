...
| TRANSACTION_EXPIRATION_QUEUE_TTL_MINUTES          |     | Transaction expiration queue events time to live parameter                                                 | number | 7 days  |
| TRANSACTION_CLOSE_PAYMENT_RETRY_QUEUE_NAME        |     | Name of the retry queue for closure error events                                                           | string |         |
| TRANSACTION_CLOSE_PAYMENT_RETRY_QUEUE_TTL_MINUTES |     | Transaction close payment retry events time to live parameter                                              | number | 7 days  |
| TRANSACTION_CLOSE_PAYMENT_QUEUE_NAME              |     | Name of the queue for close payment events                                                                 | string |         |
| TRANSACTION_CLOSE_PAYMENT_QUEUE_TTL_MINUTES       |     | Transaction close payment queue events time to live parameter                                              | number | 7 days  |
| TRANSACTION_NOTIFICATIONS_QUEUE_NAME              |     | Name of the queue for notification requested events                                                        | string |         |
| TRANSACTION_NOTIFICATIONS_QUEUE_TTL_MINUTES       |     | Transaction notification requested queue events time to live parameter                                     | number | 7 days  |
...
| TRANSACTION_REFUND_QUEUE_TTL_MINUTES              |     | Transaction refund queue events time to live parameter                                                     | number | 7 days  |
