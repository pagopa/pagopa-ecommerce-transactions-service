...
| TRANSACTION_NOTIFICATIONS_RETRY_QUEUE_NAME                         |     | Transaction notification retry queue name                                                                  | string  |         |
| USER_RECEIPT_RETRY_INTERVAL_SECONDS                                |     | Retry interval in seconds for notification retry event visibility                                          | integer |         |
