...
| ECOMMERCE_PAYMENT_INSTRUMENTS_SERVICE_URI                |     | eCommerce payment instruments service connection URI                                                       | string |         |
| ECOMMERCE_PAYMENT_INSTRUMENTS_SERVICE_READ_TIMEOUT       |     | Timeout for requests towards eCommerce payment instruments service                                         | number |         |
| ECOMMERCE_PAYMENT_INSTRUMENTS_SERVICE_CONNECTION_TIMEOUT |     | Timeout for establishing connections towards eCommerce payment instruments service                         | number |         |
| ECOMMERCE_PAYMENT_INSTRUMENTS_APY_KEY                    |     | Payment method API key                                                                                     | string |         |
