...
| REDIRECT_PSP_LIST                               |     | List of all psp ids that are expected to be found into the REDIRECT_URL_MAPPING  configuration (used for configuration cross validation)                   | string  |         |
