...
| CHECKOUT_REDIRECT_PSP_LIST                     |     | List of all psp ids that are expected to be found into the CHECKOUT_REDIRECT_URL_MAPPING and CHECKOUT_REDIRECT_LOGO_MAPPING  configuration (used for configuration cross validation) | string  |         |
